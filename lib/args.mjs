const BOOLEAN_FLAGS = new Set(['dry-run', 'yes', 'y', 'force', 'allow-exec', 'allow-login', 'allow-external-login', 'plan', 'up', 'agent', 'ccr', 'repair-plan', 'rerun', 'doctor', 'verify', 'ai', 'strict', 'branch', 'full', 'json', 'check', 'screenshots', 'worktree', 'terminals', 'console', 'watch', 'judge', 'questions']);

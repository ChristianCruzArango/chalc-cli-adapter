const BOOLEAN_FLAGS = new Set(['dry-run', 'yes', 'y', 'force', 'allow-exec']);
const VALUE_FLAGS = new Set(['target', 'method', 'mode', 'stack', 'name', 'lang', 'doc', 'azure', 'pat', 'jira', 'email', 'token', 'url', 'feature']);

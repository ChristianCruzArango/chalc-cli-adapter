const BOOLEAN_FLAGS = new Set(['dry-run', 'yes', 'y', 'force', 'allow-exec', 'plan', 'up', 'agent', 'no-ccr', 'repair-plan', 'doctor', 'verify', 'ai', 'no-ai', 'strict', 'branch', 'full']);
const VALUE_FLAGS = new Set(['target', 'method', 'mode', 'stack', 'name', 'lang', 'doc', 'azure', 'pat', 'jira', 'email', 'token', 'url', 'feature', 'spec', 'env', 'surface', 'max-steps', 'profile', 'spec-model', 'qa-model', 'repair-model', 'architecture', 'description', 'dir', 'back']);

...
// Las skills 'minimal-implementation', 'clean-code', 'solid-principles' y 'modular-architecture'
// aplican SIEMPRE (no se repiten aquí).
const GUIDES = {
  core: {
    title: 'Core',
...
const T = {
  es: { role: 'Rol', goes: 'Qué va aquí', tips: 'Buenas prácticas', skills: 'Skills que aplican', always: 'Siempre: `minimal-implementation`, `clean-code`, `solid-principles`, `modular-architecture`.', backref: 'Visión completa de la arquitectura:', genBy: 'Generado por chalc init — no borres esta guía.' },
  en: { role: 'Role', goes: 'What goes here', tips: 'Best practices', skills: 'Applicable skills', always: 'Always: `minimal-implementation`, `clean-code`, `solid-principles`, `modular-architecture`.', backref: 'Full architecture overview:', genBy: 'Generated by chalc init — keep this guide.' }
};

...
import { architectureFolders, renderArchitectureDecisionMarkdown } from './init.mjs';

// Crea las carpetas de la arquitectura (idempotente) y deja un .gitkeep en cada una.

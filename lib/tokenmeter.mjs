...
let last = { input: 0, output: 0, total: 0 };
...
// Consumo de la ÚLTIMA llamada: su `input` es el tamaño real del prompt más reciente (≈ ocupación de la
// ventana de contexto), a diferencia del acumulado, que suma prompts de pasos ya pasados.
